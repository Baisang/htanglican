    ...
    <div class="second-slide" style="background-image: linear-gradient( rgba(0, 0, 0, 0.3), rgba(0, 0, 0, 0.3)),url('<?php bloginfo('template_directory');?>/images/welcomecloudy.jpg');">
      <div class="container">
        <div class="carousel-caption">
          ...
          <p><a class="btn btn-lg btn-primary" href="http://clevelandanglican.com/what-is-anglicanism/" role="button">Learn More</a></p>
        </div>
      </div>
    </div>
  </div>
    ...
    <div class="third-slide" style="  background-image: linear-gradient( rgba(0, 0, 0, 0.3), rgba(0, 0, 0, 0.3)), url('<?php bloginfo('template_directory');?>/images/Clevelandsk.jpg');">
      <div class="container">
        <div class="carousel-caption">
          ...
          <p><a class="btn btn-lg btn-primary" href="http://clevelandanglican.com/our-story" target="_blank">Our Story</a></p>
        </div>
      </div>
    </div>
  </div>
...
<div class="row">
  <div class="col-lg-4">
    ...
    <p> Receive Church news updates via email</p>
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          <div class="modal-header">
            ...
            <h3 class="modal-title">Sign up for Church Newsletter</h3>
          </div>
  ...
  <div class="col-lg-4">
    <span class="glyphicon glyphicon-question-sign glyphs"></span>
    <h2>What to Expect</h2>
    <p>What can I expect at Transfiguration?</p>
    <button type="button" class="btn btn-default" data-toggle="modal" data-target="#morningPrayer">
      <div class="market-btn-text">See more &raquo;</div>
    </button>
  </div><!-- /.col-lg-4 -->
  <div class="col-lg-4">
...
<div class="row featurette">
  ...
  <div class="col-md-5">
    <img class="featurette-image img-responsive center-block featurette-image3" src="<?php bloginfo('template_directory');?>/images/ministries_banner.jpg" alt="serving our city">
  </div>
</div>
